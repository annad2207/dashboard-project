...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'team' in table_names, "'team' table does not exist in this database"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'employee_events' in table_names, "'employee_events' table does not exist in this database"
